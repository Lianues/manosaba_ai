        ...
        <div className="rounded-[4px] overflow-hidden fade-in">
          ...
          {step === "form" && (
            <section className="p-6 sm:p-8">
              ...
              <div className="mt-6 space-y-4">
                ...
                {/* GitHub 作者链接 */}
                <div className="mt-6 text-center text-[14px] leading-[20px] text-black/60 space-y-1">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span>Program, Prompt Design and Art By </span>
                    <a
                      href="https://github.com/Lianues"
                      target="_blank"
                  ...
                  <div>
                    <span>Program Address By </span>
                    <a
                      href="https://github.com/Lianues/manosaba_ai"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline font-bold hover:text-black transition-colors"
                    >
          ...
          {step === "progress" && (
            <section className="p-6 sm:p-8">
              ...
              {/* GitHub 作者链接 */}
              <div className="mt-8 text-center text-[14px] leading-[20px] text-black/60 space-y-1">
                <div className="flex items-center justify-center gap-2">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
